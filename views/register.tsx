                    ...
                    {({
                        ...
                        <FormControl p="$4" borderRadius="$lg">
                            <VStack alignItems='center' justifyContent='center' space="lg" mt={15}>
                                ...
                                {errors.name && touched.name && <Alert h={10} bgColor="$red300" variant="solid"><AlertText>{errors.name}</AlertText></Alert>}
                                ...
                                {errors.password_confirmation && touched.password_confirmation && <Alert h={10} bgColor="$red300" variant="solid"><AlertText>{errors.password_confirmation}</AlertText></Alert>}
                                <Input w={270} variant="rounded">
                                    <InputField
